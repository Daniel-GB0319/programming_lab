...
print("**** Lab 2: Stream Ciphers (Generador de cadenas en base64) - Cryptography - 30/October/2022 ****")
...
print('\nCadenas generadas:\n')
for i in range(N):
    key = get_random_bytes(longitud)  # Obtiene las cadenas de bytes aleatoriamente según la longitud dada
