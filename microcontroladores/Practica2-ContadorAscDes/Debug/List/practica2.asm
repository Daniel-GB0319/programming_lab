...
; 0000 0085 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0086 
; 0000 0087 // Inicializa los puertos
; 0000 0088 PORTB=0xFF;
	LDI  R30,LOW(255)
	OUT  0x18,R30
...
; 0000 008E PORTB++; // Incrementa una unidad al contador
	IN   R30,0x18
	SUBI R30,-LOW(1)
	OUT  0x18,R30
; 0000 008F PORTD--; // Decrementa una unidad al contador
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
