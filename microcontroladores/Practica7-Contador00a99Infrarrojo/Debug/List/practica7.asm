...
_0x11:
	BLD  R2,1
; 0000 0093 if ((botonp==1)&&(botona==0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
...
_0xA:
; 0000 0094 {
; 0000 0095 var++; //Se incrementa la variable de las unidades
	INC  R5
; 0000 0096 if (var==10){ // Evalua si se debe aumentar las decenas
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0xB
; 0000 0097 var=0; // Reestablece las unidades a cero
	CLR  R5
; 0000 0098 var2++; // Aumenta las decenas
	INC  R4
; 0000 0099 if(var2==10)  //  Evalua si se ha llegado al limite de las decenas
	CP   R30,R4
	BRNE _0xC
; 0000 009A var2=0; // Reestablece las decenas a cero
	CLR  R4
; 0000 009B 
; 0000 009C }
_0xC:
...
; 0000 00A0 delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	...
	RCALL _delay_ms
; 0000 00A1 
; 0000 00A2 PORTA=tabla7segmentos [var]; // Aumenta digitos de las unidades
_0xD:
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 00A3 PORTB=tabla7segmentos [var2]; // Aumenta digitos de las decenas
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x18,R0
