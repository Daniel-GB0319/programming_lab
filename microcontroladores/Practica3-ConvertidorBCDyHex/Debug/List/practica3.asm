...
; 0000 008B variable=PIND&0x0f; // Enmascara los 4 bits menos significativos del puerto A ya que los demas no interesan
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 008C if (variable<10)
	LDI  R30,LOW(10)
	CP   R5,R30
	BRSH _0x6
; 0000 008D PORTB=tabla7segmentos[variable];
	MOV  R30,R5
	LDI  R31,0
	...
	OUT  0x18,R0
; 0000 008E 
; 0000 008F if (variable>=10) // Si lo que leemos es mayor o igual a 10 que dibuje en el display una E de ERROR
_0x6:
	LDI  R30,LOW(10)
	CP   R5,R30
	BRLO _0x7
; 0000 0090 PORTB=0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 0091 
; 0000 0092 }
