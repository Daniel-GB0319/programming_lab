...
while (1)
      ...
      variable=PIND&0x0f; // Enmascara los 4 bits menos significativos del puerto A ya que los demas no interesan
      if (variable<10)
        PORTB=tabla7segmentos[variable];
        
      if (variable>=10) // Si lo que leemos es mayor o igual a 10 que dibuje en el display una E de ERROR
        PORTB=0x79; 
