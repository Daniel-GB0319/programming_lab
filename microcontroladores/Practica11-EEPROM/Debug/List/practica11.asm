...
; 0000 0039 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 003A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=P Bit0=P
; 0000 003B PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 003C 
...
; 0000 0098 PORTB=tabla7segmentos [var];
	...
	OUT  0x18,R0
; 0000 0099 
; 0000 009A if (boton_guarda==0) //Si se presiona el botón de guardar
	SBIC 0x13,1
	RJMP _0x7
; 0000 009B datoaguardar=var; //se grabara la eeprom con el valor de var
	MOV  R30,R5
	RCALL SUBOPT_0x0
	RCALL __EEPROMWRB
; 0000 009C 
...
_0x12:
	BLD  R2,1
; 0000 00A7 
; 0000 00A8 if ((botonp==1)&&(botona==0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xC
	SBRS R2,1
	RJMP _0xD
...
_0xD:
; 0000 00A9 {
; 0000 00AA var++; //Se incrementa la variable
	INC  R5
; 0000 00AB 
; 0000 00AC if (var>=10)
	LDI  R30,LOW(10)
...
; 0000 00AD var=0;
	CLR  R5
; 0000 00AE 
; 0000 00AF delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
_0xE:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00B0 }
; 0000 00B1 
; 0000 00B2 if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0xB:
	SBRC R2,0
	RJMP _0x10
	SBRC R2,1
...
_0x10:
	RJMP _0xF
_0x11:
; 0000 00B3 delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00B4 
