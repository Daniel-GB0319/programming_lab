...
; 0000 0090 if(semaforo==1){
	SBRS R2,0
	RJMP _0x6
; 0000 0091 dec_seg++; //Se incrementa la variable de las decimas de segundo
	INC  R5
; 0000 0092 
; 0000 0093 if (dec_seg==10){ // Evalua si se debe aumentar las decimas
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x7
; 0000 0094 dec_seg=0; // Reestablece las decimas de segundo a cero
	CLR  R5
; 0000 0095 seg1++; // Aumenta las unidades de segundo
	INC  R4
; 0000 0096 
; 0000 0097 if(seg1==10){  //  Evalua si se ha llegado al limite de las unidades de segundo
	CP   R30,R4
	BRNE _0x8
; 0000 0098 seg1=0; // Reestablece las unidades de segundo a cero
	CLR  R4
; 0000 0099 seg2++; // Aumenta las decenas de segundo
	INC  R7
; 0000 009A 
; 0000 009B if(seg2==10){
	CP   R30,R7
	BRNE _0x9
; 0000 009C seg2=0;
	CLR  R7
; 0000 009D semaforo=0;
	CLT
	BLD  R2,0
; 0000 009E }
; 0000 009F 
...
; 0000 00A1 }
_0x8:
; 0000 00A2 delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
_0x7:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A3 } // if semaforo
; 0000 00A4 
; 0000 00A5 if(reset==0){
_0x6:
	SBIC 0x10,0
	RJMP _0xA
; 0000 00A6 dec_seg=0;
...
_0xA:
	SBIC 0x10,1
	RJMP _0xB
; 0000 00AC semaforo=0;
	CLT
	BLD  R2,0
; 0000 00AD 
; 0000 00AE if(start==0)
_0xB:
	SBIC 0x10,2
	RJMP _0xC
; 0000 00AF semaforo=1;
	SET
	BLD  R2,0
; 0000 00B0 
...
_0xC:
	...
	RCALL _delay_ms
; 0000 00B2 
; 0000 00B3 PORTB=tabla7segmentos [seg2]; // Muestra las decenas de segundo
	MOV  R30,R7
	RCALL SUBOPT_0x0
	OUT  0x18,R0
; 0000 00B4 PORTA=tabla7segmentos [seg1]; // Muestra las unidades de segundo
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 00B5 PORTC=tabla7segmentos [dec_seg]; // Muestra las decimas de segundo
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x15,R0
; 0000 00B6 }
