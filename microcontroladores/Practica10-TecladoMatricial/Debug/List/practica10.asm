...
; 0000 008B //C0 A C2 son de salida y son para probar las 3 columnas
; 0000 008C 
; 0000 008D //Se prueba la primera columna se envía 110
; 0000 008E PORTC=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 008F //C3, C4 y C5 son las entradas del teclado, por eso se enmascaran con 00111000
...
; 0000 0093 tecla=7;
	...
	MOV  R5,R30
; 0000 0094 
; 0000 0095 if (lectura==0b00101000)
_0x6:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x7
; 0000 0096 tecla=8;
	...
	MOV  R5,R30
; 0000 0097 
; 0000 0098 if (lectura==0b00011000)
_0x7:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x8
; 0000 0099 tecla=9;
	...
	MOV  R5,R30
; 0000 009A 
; 0000 009B //se prueba segunda columna se envía 101
; 0000 009C PORTC=0b00111101;
_0x8:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 009D 
; 0000 009E //C3, C4 y C5 son las entradas del teclado, por eso se enmascaran con 00111000
; 0000 009F lectura=PINC&0b00111000;
; 0000 00A0 
; 0000 00A1 if (lectura==0b00110000)
	BRNE _0x9
; 0000 00A2 tecla=4;
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 00A3 
; 0000 00A4 if (lectura==0b00101000)
_0x9:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xA
; 0000 00A5 tecla=5;
	...
	MOV  R5,R30
; 0000 00A6 
; 0000 00A7 if (lectura==0b00011000)
_0xA:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xB
; 0000 00A8 tecla=6;
	...
	MOV  R5,R30
; 0000 00A9 
; 0000 00AA //se prueba tercera columna se envía 011
; 0000 00AB PORTC=0b00111011;
_0xB:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 00AC 
; 0000 00AD //C3, C4 y C5 son las entradas del teclado, por eso se enmascaran con 00111000
; 0000 00AE lectura=PINC&0b00111000;
; 0000 00AF 
; 0000 00B0 if (lectura==0b00110000)
	BRNE _0xC
; 0000 00B1 tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00B2 
; 0000 00B3 if (lectura==0b00101000)
_0xC:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xD
; 0000 00B4 tecla=2;
	...
	MOV  R5,R30
; 0000 00B5 
; 0000 00B6 if (lectura==0b00011000)
_0xD:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xE
; 0000 00B7 tecla=3;
	...
	MOV  R5,R30
; 0000 00B8 
; 0000 00B9 PORTB=tabla7segmentos [tecla];
_0xE:
	MOV  R30,R5
	LDI  R31,0
